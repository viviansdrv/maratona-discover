...
const Storage = {
    get(){
        return JSON.parse(localStorage.getItem("dev.finances:transactions")) || [] // se não tiver o dev.finances, ele irá retornar vazio
    },
    set(transactions){
...
const App = {
    init(){
        Transaction.all.forEach(DOM.addTransaction) // não entendi essa parte
